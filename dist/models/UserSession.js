...
const locationTrackingPointSchema = new mongoose_1.Schema({
    latitude: { type: Number, required: true },
    longitude: { type: Number, required: true },
    accuracy: { type: Number, required: true },
    altitude: { type: Number },
...
const crashReportSchema = new mongoose_1.Schema({
    type: {
        type: String,
    ...
    stack: { type: String },
    timestamp: { type: Date, required: true },
    context: { type: mongoose_1.Schema.Types.Mixed, required: true }
}, { _id: false });

...
import type { User, UserPreferences, SupportedLanguage, AudioQuality, FontSize } from '@/types';
...
const mapFirebaseUserToUser = async (firebaseUser: FirebaseUser): Promise<User> => {
  ...
  return {
    ...
    subscription: (userData?.subscription as SubscriptionTier) || SubscriptionTier.FREE,
